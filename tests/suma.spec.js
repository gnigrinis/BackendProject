...
// 1
console.log("test1: retorna null cuando uno de los parametros no es numerico")
totalTests++
...
// 2
console.log("test2: retorna 0 cuando uno de los parametros no es numerico")
totalTests++
const result2 = suma()
if (result2 === 0) {
...
// 4
console.log("test3: retorna 31 cuando 2, 4, 10 y 15")
totalTests++
